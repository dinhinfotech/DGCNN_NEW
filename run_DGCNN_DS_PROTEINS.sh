...
# input arguments
DATA="NCI1"  # MUTAG, ENZYMES, NCI1, NCI109, DD, PTC, PROTEINS, COLLAB, IMDBBINARY, IMDBMULTI
# general settings
gm=DGCNN_DS  # model: DGCNN, DGCNN_RNN, DGCNN_DS, DGCNN_LSTM,
gpu_or_cpu=gpu
GPU=0  # select the GPU number
CONV_SIZE="32-32-32"
sortpooling_k=196  # If k <= 1, then k is set to an integer so that k% of graphs have nodes less than this integer
