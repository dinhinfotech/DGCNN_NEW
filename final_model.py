...
class Classifier(nn.Module):
    def __init__(self):
        ...
        if cmd_args.gm == 'DGCNN' or cmd_args.gm == 'DGCNNDS' or 'DGCNN_RNN' or 'DGCNN_LSTM':
        ...
        if cmd_args.gm == 'DGCNN' or cmd_args.gm == 'DGCNNDS':
            ...
            self.mlp = MLP_LSTM_Classifier(input_size=sum(cmd_args.latent_dim), hidden_size=cmd_args.hidden, num_class=cmd_args.num_class, with_dropout=cmd_args.dropout)
